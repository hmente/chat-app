...
chatRoomSchema.statics.initiateChat = async function (
  ...
  try {
      //checks if a chatroom exists or not for a specific user 
    ...
    //the searched chatroom is found, return existing chatroom
    if (availableRoom) {
      return {
        isNew: false,
    ...
    //the searched chatroom is not found, create a new one
